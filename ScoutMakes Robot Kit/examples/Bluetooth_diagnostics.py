"""
This test will initialize the BLE module and accept commands from the Bluetooth app controller arrows and manipulate the onboard NEOPIXEL colors.

To use:
- Open the BLE app (Adafruit's Bluefruit Connect available in iOS and Android).
- Connect to the CIRCUITPYTHON board.
- Select the controller module.
- Select control pad.
